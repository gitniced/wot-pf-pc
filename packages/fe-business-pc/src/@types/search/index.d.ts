...
/**
 * requestUrl /search/front/apply/page_activity_saas
 * method post
 */
...
/**
 * requestUrl /search/front/apply/page_activity_site
 * method post
 */
 ...
 * method post
 */
export interface UpdateRecordStatusUsingPOSTRequest {
    /** 审核意见 */
    auditComment?: string
    /** 报名记录唯一编码 */
    code?: string
    /** 报名状态：2未缴费、3过期未缴费、4报名成功、5报名失败、6已退费 */
    status?: number
}
...
/**
 * requestUrl /search/sync/contract/region_data
 * method post
 */
export interface RegionContractUsingPOSTRequest {
    /** 结束时间 */
    endTime?: number
    /** 地区Id列表 */
    provinceList?: any[]
 ...
 * method post
 */
export interface RegionContractUsingPOSTResponse {
    /** 响应数据 */
    data?: RegionNumDto
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /search/sync/contract/sale_contract_statistic
 * method post
 */
export interface ContractNumUsingPOSTRequest {
    /** 结束时间 */
    endTime?: number
    /** 地区Id列表 */
    provinceList?: any[]
 ...
 * method post
 */
export interface ContractNumUsingPOSTResponse {
    /** 响应数据 */
    data?: ContractNumDto
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /search/sync/customer/region_data
 * method post
 */
export interface RegionCustomerUsingPOSTRequest {
    /** 结束时间 */
    endTime?: number
    /** 地区Id列表 */
    provinceList?: any[]
 ...
 * method post
 */
export interface RegionCustomerUsingPOSTResponse {
    /** 响应数据 */
    data?: RegionNumDto
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /search/sync/customer/sale_statistic
 * method post
 */
export interface CountTodayAddUsingPOSTRequest {
    /** 结束时间 */
    endTime?: number
    /** 地区Id列表 */
    provinceList?: any[]
 ...
 * method post
 */
export interface CountTodayAddUsingPOSTResponse {
    /** 响应数据 */
    data?: CustomerNumDto
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /search/backend/finance/overdue_count
 * method post
 */
...
/**
 * requestUrl /search/backend/finance/overdue_customer_rank
 * method post
 */
...
/**
 * requestUrl /search/backend/finance/overdue_stat
 * method post
 */
...
/**
 * requestUrl /search/backend/finance/overdue_warning
 * method post
 */
...
/**
 * requestUrl /search/backend/finance/page_overdue_management
 * method post
 */
...
interface BasePaginationRspBackendPaymentCollectionPageRespDto {
    /** 当前页码 */
    currentPage?: number
    /** 数据 */
    data?: BackendPaymentCollectionPageRespDto
    /** 每页记录数 */
    pageSize?: number
    /** 总页数 */
    pages?: number
...
interface BackendPaymentCollectionPageRespDto {
    /** 唯一编码 */
    code?: string
    /** 完成率,保留2位小数 */
    completeRate?: number
    /** 完成率统计枚举，1:0~20%,2:21~40%,3:41~60%,4:61~80%,5:81~99%,6:100% */
    completeRateStat?: number
    /** 创建时间 */
    createdAt?: number
    /** 客户编码 */
    customerCode?: string
    ...
    overdue?: boolean
    /** 自定义逾期原因 */
    overdueReasonCustom: string
    /** 逾期原因,1政策原因、2补贴原因、3机构原因、4付款压力、5寻求机会、6其他原因 */
    overdueReasons?: any[]
    /** 预计回款日期 */
    predictPayDate?: string
    /** 客户所在省份编号 */
    province?: number
    /** 省份名称 */
    provinceName?: string
...
/**
 * requestUrl /search/backend/finance/page_payment_collection
 * method post
 */
export interface PagePaymentCollectionUsingPOSTRequest {
    /** 完成率统计枚举，1:0~20%,2:21~40%,3:41~60%,4:61~80%,5:81~99%,6:100% */
    completeRateQuery?: number
    /** 客户编码 */
    customerCode?: string
    /** 跟进日期-查询结束日期 */
    ...
    orderBy?: string
    /** 逾期原因,1政策原因、2补贴原因、3机构原因、4付款压力、5寻求机会、6其他原因 */
    overdueReasonQuery?: any[]
    /** 页码，从1开始数，默认是1 */
    pageNo?: number
    /** 单页显示数量，默认是10 */
    pageSize?: number
    /** 预计回款日期-查询结束日期 */
    predictPayEndDate?: string
    /** 预计回款日期-查询开始日期 */
    predictPayStartDate?: string
    /** 省份编码 */
    province?: number
    /** 省份id数组 */
    provinces?: any[]
 ...
 * method post
 */
export interface PagePaymentCollectionUsingPOSTResponse {
    /** 响应数据 */
    data?: BasePaginationRspBackendPaymentCollectionPageRespDto
    /** 响应消息 */
    message?: string
    /** 响应消息编码 */
    messageCode?: string
...
interface BackendPaymentCollectionStatRespDto {
    /** 统计项 */
    stats?: PaymentCollectionStatItem
    /** 已跟进回款总额 */
    totalAmount?: number
    /** 总订单数 */
...
interface PaymentCollectionStatItem {
    /** 跟进金额 */
    amount?: number
    /** 1、按预计回款统计：月份中文；2、按完成率统计：0~20%、21~40%、41~60%、61~80%、81~99%、100% */
    label?: string
    /** 订单数 */
    orderCount?: number
}
...
/**
 * requestUrl /search/backend/finance/stat_payment_collection
 * method post
 */
export interface StatPaymentCollectionUsingPOSTRequest {
    /** 完成率统计枚举，1:0~20%,2:21~40%,3:41~60%,4:61~80%,5:81~99%,6:100% */
    completeRateQuery?: number
    /** 客户编码 */
    customerCode?: string
 ...
 * method post
 */
export interface StatPaymentCollectionUsingPOSTResponse {
    /** 响应数据 */
    data?: BackendPaymentCollectionStatRespDto
    /** 响应消息 */
    message?: string
    /** 响应消息编码 */
    messageCode?: string
...
/**
 * requestUrl /search/sync/finance/batch_delete_overdue_management
 * method post
 */
export interface BatchDeleteOverdueManagementUsingPOSTResponse {
    /** 响应数据 */
    data?: boolean
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /search/sync/finance/batch_save_overdue_management
 * method post
 */
export interface BatchSaveOverdueManagementUsingPOSTRequest {}

/**
 * requestUrl /search/sync/finance/batch_save_overdue_management
 * method post
 */
export interface BatchSaveOverdueManagementUsingPOSTResponse {
    /** 响应消息 */
    message?: string
    /** 响应消息编码 */
    messageCode?: string
...
/**
 * requestUrl /search/sync/finance/delete_payment_collection
 * method post
 */
export interface DeletePaymentCollectionUsingPOSTResponse {
    /** 响应消息 */
    message?: string
    /** 响应消息编码 */
    messageCode?: string
...
/**
 * requestUrl /search/sync/finance/save_payment_collection
 * method post
 */
export interface SavePaymentCollectionUsingPOSTRequest {
    /** 唯一编码 */
    code?: string
    /** 完成率,保留2位小数 */
    completeRate?: number
 ...
 * method post
 */
export interface SavePaymentCollectionUsingPOSTResponse {
    /** 响应消息 */
    message?: string
    /** 响应消息编码 */
    messageCode?: string
...
/**
 * requestUrl /search/sync/finance/update_overdue_management
 * method post
 */
export interface UpdateOverdueManagementUsingPOSTRequest {
    /** 唯一编码 */
    code?: string
    /** 预计支付日期-预计支付时间取日期 */
    expectPayDate?: string
 ...
 * method post
 */
export interface UpdateOverdueManagementUsingPOSTResponse {
    /** 响应数据 */
    data?: string
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /search/sync/finance/update_payment_collection
 * method post
 */
export interface UpdatePaymentCollectionUsingPOSTRequest {
    /** 唯一编码 */
    code?: string
    /** 完成率,保留2位小数 */
    completeRate?: number
 ...
 * method post
 */
export interface UpdatePaymentCollectionUsingPOSTResponse {
    /** 响应消息 */
    message?: string
    /** 响应消息编码 */
    messageCode?: string
...
/**
 * requestUrl /search/backend/goods/count_goods
 * method post
 */
export interface CountOnSaleGoodsUsingPOSTRequest {
    /** 省份 */
    province?: number
}
 ...
 * method post
 */
export interface CountOnSaleGoodsUsingPOSTResponse {
    /** 响应数据 */
    data?: number
    /** 响应消息 */
    message?: string
 ...
 * method post
 */
export interface StatusCountUsingPOSTRequest {
    /** 开票日期-查询结束日期 */
    endTime?: string
    /** 发票申请编号 */
    invoiceNo?: string
 ...
 * method post
 */
export interface StatusCountUsingPOSTResponse {
    /** 响应数据 */
    data?: 键值对返回对象intlong
    /** 响应消息 */
    message?: string
 ...
 * method get
 */
export interface ListUserTitleUsingGETResponse {
    /** 响应数据 */
    data?: InvoiceTitleIndex
    /** 响应消息 */
    message?: string
    /** 响应消息编码 */
    messageCode?: string
...
/**
 * requestUrl /search/backend/order/in_due_stat
 * method post
 */
...
/**
 * requestUrl /search/backend/order/order_count_and_amount_stat_for_market
 * method post
 */
...
/**
 * requestUrl /search/backend/order/order_count_and_amount_stat_for_sale
 * method post
 */
...
/**
 * requestUrl /search/backend/order/order_count_stat
 * method post
 */
...
/**
 * requestUrl /search/backend/order/order_count_stat_by_day
 * method post
 */
...
interface OrderPaidSalePaymentCollectionDto {
    /** 日期 */
    date?: string
    /** 日期中文名称 */
    dateName?: string
    /** 已回款订单统计 */
    paidStat?: OrderPaidSalePaymentCollectionItem
    /** 预计回款统计 */
    predictStat?: OrderPaidSalePaymentCollectionItem
    /** 销售订单统计 */
    saleStat?: OrderPaidSalePaymentCollectionItem
}

interface OrderPaidSalePaymentCollectionItem {
    /** 订单金额 */
    orderAmount?: number
    /** 订单数量 */
    orderCount?: number
...
/**
 * requestUrl /search/backend/order/order_paid_sale_payment_collection_stat
 * method post
 */
export interface OrderPaidSalePaymentCollectionStatUsingPOSTRequest {
    /** 查询结束时间 */
    endTime?: string
    /** 销售员所在省份编码 */
    provinces?: any[]
 ...
 * method post
 */
export interface OrderPaidSalePaymentCollectionStatUsingPOSTResponse {
    /** 响应数据 */
    data?: OrderPaidSalePaymentCollectionDto
    /** 响应消息 */
    message?: string
    /** 响应消息编码 */
    messageCode?: string
 ...
 * method post
 */
export interface GetOrderPayStatusAndCountUsingPOSTRequest {
    /** 实收款-最高金额 */
    amountHigh?: number
    /** 实收款-最低金额 */
    amountLow?: number
 ...
 * method post
 */
export interface GetOrderPayStatusAndCountUsingPOSTResponse {
    /** 响应数据 */
...
interface BackendOrderPredictStatRespDto {
    /** 未跟进回款金额 */
    notFollowedAmount?: number
    /** 未跟进客户数 */
    notFollowedCustomerCount?: number
    /** 未跟进订单数 */
    notFollowedOrderCount?: number
}

/**
 * requestUrl /search/backend/order/order_predict_stat
 * method post
 */
export interface OrderPredictStatUsingPOSTRequest {
    /** 实收款-最高金额 */
    amountHigh?: number
    /** 实收款-最低金额 */
    amountLow?: number
 ...
 * method post
 */
export interface OrderPredictStatUsingPOSTResponse {
    /** 响应数据 */
    data?: BackendOrderPredictStatRespDto
    /** 响应消息 */
    message?: string
    /** 响应消息编码 */
    messageCode?: string
...
/**
 * requestUrl /search/backend/order/order_stat_in_year
 * method post
 */
 ...
 * method post
 */
export interface GetOrderStatusAndCountUsingPOSTRequest {
    /** 实收款-最高金额 */
    amountHigh?: number
    /** 实收款-最低金额 */
    amountLow?: number
 ...
 * method post
 */
export interface GetOrderStatusAndCountUsingPOSTResponse {
    /** 响应数据 */
    data?: Record<string | number | symbol, any>
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /search/backend/order/repayment_rate
 * method post
 */
...
/**
 * requestUrl /search/backend/order/sales_stat
 * method post
 */
...
/**
 * requestUrl /search/backend/order/stat_in_due_money
 * method post
 */
...
interface BasePaginationRsp我的可开票订单列表响应对象 {
    /** 当前页码 */
    currentPage?: number
    /** 数据 */
    data?: 我的可开票订单列表响应对象
...
/**
 * requestUrl /search/front/order/page_for_invoice
 * method post
 */
...
export interface ListForInvoiceUsingPOSTResponse {
    /** 响应数据 */
    data?: BasePaginationRsp我的可开票订单列表响应对象
    /** 响应消息 */
    message?: string
    /** 响应消息编码 */
    messageCode?: string
...
/**
 * requestUrl /search/sync/order/batch_update_php
 * method post
 */
export interface BatchUpdateForPhpUsingPOSTRequest {}

/**
 * requestUrl /search/sync/order/batch_update_php
 * method post
 */
export interface BatchUpdateForPhpUsingPOSTResponse {
    /** 响应数据 */
    data?: boolean
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /search/sync/receive/batch_update_age
 * method post
 */
export interface BatchDeleteGoodsCategoryUsingPOST_1Request {}

/**
 * requestUrl /search/sync/receive/batch_update_age
 * method post
 */
export interface BatchDeleteGoodsCategoryUsingPOST_1Response {
    /** 响应消息 */
    message?: string
    /** 响应消息编码 */
    messageCode?: string
...
/**
 * requestUrl /search/sync/receive/page
 * method post
 */
...
/**
 * requestUrl /search/sync/receive/save
 * method post
 */
...
/**
 * requestUrl /search/sync/receive/save_log
 * method post
 */
 ...
 * method post
 */
export interface SaveLogUsingPOSTResponse {
    /** 响应消息 */
    message?: string
    /** 响应消息编码 */
    messageCode?: string
...
/**
 * requestUrl /search/sync/receive/statistics
 * method post
 */
export interface StatisticsUsingPOSTRequest {
    /**  账龄 */
    aging?: number
    /** 应收单id */
    arNo?: string
 ...
 * method post
 */
export interface StatisticsUsingPOSTResponse {
    /** 响应数据 */
 ...
 * method post
 */
export interface PageUsingPOST_11Request {
    /**  */
    name?: string
    /** 升降序规则,ASC或DESC */
    order?: string
 ...
 * method post
 */
export interface PageUsingPOST_11Response {
    /** 响应数据 */
 ...
 * method post
 */
export interface SaveUsingPOST_6Request {
    /** 别名code */
    aliasCode?: string
    /** code */
    code?: string
 ...
 * method post
 */
export interface SaveUsingPOST_6Response {
    /** 响应数据 */
    data?: string
    /** 响应消息 */
    message?: string
