...
switch (process.env.BUILD_ENV) {
    case 'dev':
        publicPath = `https://static.zpimg.cn/dev/fe_enroll_no_permission_pc/` //开发
        break
    case 'test':
        publicPath = `https://static.zpimg.cn/test/fe_enroll_no_permission_pc/` //测试
        break
    case 'pre':
        publicPath = `https://static.zpimg.cn/pre/fe_enroll_no_permission_pc/` //预发
        break
    case 'pro':
        publicPath = `https://static.zpimg.cn/pro/fe_enroll_no_permission_pc/` //正式
        break
    default:
        //开发
