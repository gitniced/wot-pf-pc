...
/**报名项目类型值 */
export const EVENT_KIND_VALUE: Record<string, number> = {
    /**机构 */
...
/**报名项目类型名称 */
export const EVENT_KIND_NAME: Record<string, string> = {
    /**机构 */
    [EVENT_KIND.ORGANIZATION]: '机构',
    /**评价计划 */
    [EVENT_KIND.REVIEWS_PLAN]: '评价计划',
    /**培训计划 */
    [EVENT_KIND.TRAINING_PLAN]: '培训计划',
    /**培训班级 */
    [EVENT_KIND.TRAINING_CLASS]: '培训班级',
    /**职业 */
    [EVENT_KIND.CAREER]: '职业',
    /**技能竞赛 */
    [EVENT_KIND.COMPETITION]: '技能竞赛',
    /**站点活动 */
    [EVENT_KIND.EVENTS]: '站点活动',
    /**通用  */
    [EVENT_KIND.COMMON]: '通用',
}

/**不同报名项目类型对应的时间选项名称 */
export const EVENT_KIND_TIME_NAME: Record<string, string> = {
    [EVENT_KIND_VALUE[EVENT_KIND.REVIEWS_PLAN]]: '认定考试时间',
    [EVENT_KIND_VALUE[EVENT_KIND.TRAINING_PLAN]]: '培训时间',
    [EVENT_KIND_VALUE[EVENT_KIND.TRAINING_CLASS]]: '培训时间',
    [EVENT_KIND_VALUE[EVENT_KIND.COMPETITION]]: '技能竞赛时间',
    [EVENT_KIND_VALUE[EVENT_KIND.COMMON]]: '活动时间',
    [EVENT_KIND_VALUE[EVENT_KIND.EVENTS]]: '活动时间',
}
...
/**报名渠道  1站点门户 2机构门户 3报名链接 4推广二维码 5推广海报 */
export const ENROLL_CHANNEL_VALUE_ENUM = {
    site: ENROLL_CHANNEL.SITE,
    organization: ENROLL_CHANNEL.ORGANIZATION,
    link: ENROLL_CHANNEL.LINK,
    qrcode: ENROLL_CHANNEL.QRCODE,
    poster: ENROLL_CHANNEL.POSTER,
}
