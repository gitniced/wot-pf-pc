            ...
            <div className={styles.content}>
                ...
                <header className={styles.header}>
                    <div className={styles.content}>
                        ...
                        <Progress className={styles.progress} strokeColor='var(--primary-color)' width={72} type="circle" percent={rate} format={percent => `${percent}%`} />
                    </div>
                </header>
                <div className={styles.list}>
                    {companyInfoList.map((item) => (
                        <div className={[styles.item, tab === item.tab && styles.active].join(' ')} key={item.tab} onClick={() => setTab(item.tab)}>
