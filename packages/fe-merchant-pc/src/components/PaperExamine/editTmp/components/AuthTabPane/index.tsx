...
const AuthTabPane: FC<{ data?: AuthDetailType }> = props => {
    ...
    const renderFunc = (text: string) => <span className={styles.keep_original}>{text || '-'}</span>
