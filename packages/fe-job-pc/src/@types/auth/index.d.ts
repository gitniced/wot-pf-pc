...
export interface ImportFileUsingPOSTRequest {
  ...
  /** 导出筛选参数 json */
  param?: string
  /** 批量操作类型1组织成员导入 2批量删除 3试题导入 4导出订单报表 5导出订单商品报表 6导出售后单 7标签关联职业 8导入站点职业 */
  type: number
}
...
export interface CertifyUploadInfoUsingPOSTRequest {
  ...
  /** hash */
  hash: string
  /** 文件类型 1导入组织成员 2用户头像 3合同附件 4客户附件 */
  type: number
  /** 地址 */
  url: string
  /** 用户编码 */
