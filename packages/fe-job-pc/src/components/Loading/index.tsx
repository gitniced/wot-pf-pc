...
const GlobalLoading = () => {
    ...
    const LoadingDOM = (props: LoadingProps) => {
        ...
        return (
            ...
            >
                <div className="ant-spin-nested-loading" style={{ top: '100px' }}>
                    <div>
                        <div className="ant-spin ant-spin-lg ant-spin-spinning">
                            ...
                            <div className="ant-spin-text" style={{ paddingTop: '20px' }}>
                                {message}
                            </div>
                        </div>
                    </div>
     ...
     * @param message
     */
    LoadingDOM.show = (message: string, mask: boolean = false) => {
