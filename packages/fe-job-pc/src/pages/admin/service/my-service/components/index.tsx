...
import { jobStateList, personLevel, STATUS_COLOR, STATUS_TEXT } from '../../hierarchical-diagnosis/diagnosis/consts'
            ...
            <div className={styles.bottom}>
                <div className={styles.step_wrapper}>
                    <div className={styles.second_step_content}>
                        ...
                        {/* 帮扶措施 */}
                        <AssistanceMeasures isRecord={isRecord} />

                        {/* 服务记录 */}
                        <ServiceRecord isRecord={isRecord} />
                    </div>
                </div>
            </div>
        </div>
