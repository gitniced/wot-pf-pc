...
switch (process.env.BUILD_ENV) {
    case 'dev':
        publicPath = `https://static.zpimg.cn/dev/fe_job_pc/` //开发
        break
    case 'test':
        publicPath = `https://static.zpimg.cn/test/fe_job_pc/` //测试
        break
    case 'pre':
        publicPath = `https://static.zpimg.cn/pre/fe_job_pc/` //预发
        break
    case 'pro':
        publicPath = `https://static.zpimg.cn/pro/fe_job_pc/` //正式
        break
    default:
        //开发
...
const htmlConfig = {
    headScripts: [
        ...
        {
            src: 'https://static.zpimg.cn/public/job-pc/iconfont.js?time=18',
        },
        {
