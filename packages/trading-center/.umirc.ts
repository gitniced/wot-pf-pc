...
switch (process.env.BUILD_ENV) {
    case 'dev':
        publicPath = `https://static.zpimg.cn/dev/fe-user-trading-center/` //开发
        break
    case 'test':
        publicPath = `https://static.zpimg.cn/test/fe-user-trading-center/` //测试
        break
    case 'pre':
        publicPath = `https://static.zpimg.cn/pre/fe-user-trading-center/` //预发
        break
    case 'pro':
        publicPath = `https://static.zpimg.cn/pro/fe-user-trading-center/` //正式
        break
    default:
        //开发
        publicPath = `/`
