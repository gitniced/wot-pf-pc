...
/**
 * requestUrl /finance/callback/payxx
 * method post
 */
export interface PayUsingPOSTRequest {}

/**
 * requestUrl /finance/callback/payxx
 * method post
 */
export interface PayUsingPOSTResponse {
    /** 响应数据 */
...
interface BasePaginationRsp合同订单信息数据 {
    /** 当前页码 */
    currentPage?: number
    /** 数据 */
    data?: 合同订单信息数据
...
/**
 * requestUrl /finance/contract/contract_order
 * method post
 */
export interface ContractOrderUsingPOSTRequest {
    /** 合同编码 */
    contractCode?: string
    /** 升降序规则,ASC或DESC */
    order?: string
 ...
 * method post
 */
export interface ContractOrderUsingPOSTResponse {
    /** 响应数据 */
    data?: BasePaginationRsp合同订单信息数据
    /** 响应消息 */
    message?: string
    /** 响应消息编码 */
    messageCode?: string
...
export interface OverdueStatUsingPOSTRequest {
    ...
    /** 站点id */
    sid?: number
    /** 逾期阶段查询，1:短信通知，2:智能外呼,3:发送催款函,4:暂停服务通知,5:限制服务 */
    stageQuery?: number
...
interface BackendOverdueManagementPageRespDto {
    ...
    /** 逾期天数 */
    overdueDays?: number
    /** 逾期阶段，1:短信通知，2:智能外呼,3:发送催款函,4:暂停服务通知,5:限制服务 */
    overdueStage?: number
    /** 逾期统计枚举，1:5天以内,2:6~10天,3:11~20天,4:21~30天,5:31~90天,6:91天以上 */
    overdueStat?: number
    /** 客户所在省份编号，同订单 */
...
/**
 * requestUrl /finance/callback/pay
 * method post
 */
...
/**
 * requestUrl /finance/callback/pay1
 * method post
 */
export interface QrcodeApply1UsingPOSTResponse {
    /** 响应数据 */
    data?: 支付结果通知返回参数
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /finance/callback/pay2
 * method post
 */
export interface QrcodeApply2UsingPOSTResponse {
    /** 响应数据 */
    data?: 支付结果通知返回参数
    /** 响应消息 */
    message?: string
