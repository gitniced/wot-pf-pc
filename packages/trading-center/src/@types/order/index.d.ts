...
/**
 * requestUrl /order/backend/add_preferential
 * method post
 */
export interface AddPreferentialUsingPOSTRequest {
    /** 订单编码 */
    code?: string
    /** 优惠金额 */
    preferential?: number
 ...
 * method post
 */
export interface AddPreferentialUsingPOSTResponse {
    /** 响应数据 */
    data?: string
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /order/backend/batch_update_es
 * method get
 */
export interface BatchUpdateEsUsingGETResponse {
    /** 响应数据 */
    data?: boolean
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /order/backend/batch_update_order_php
 * method post
 */
export interface BatchUpdateOrderPhpUsingPOSTRequest {}

/**
 * requestUrl /order/backend/batch_update_order_php
 * method post
 */
export interface BatchUpdateOrderPhpUsingPOSTResponse {
    /** 响应数据 */
    data?: boolean
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /order/backend/batch_update_predict_pay_date
 * method post
 */
export interface BatchUpdatePredictPayDateUsingPOSTRequest {
    /** 合同订单编码 */
    orderCodes?: any[]
    /** 业财回款管理,预计回款日期 */
 ...
 * method post
 */
export interface BatchUpdatePredictPayDateUsingPOSTResponse {
    /** 响应数据 */
    data?: boolean
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /order/backend/export_contract_order
 * method get
 */
export interface ExportContractOrderUsingGETResponse {}
...
/**
 * requestUrl /order/backend/remove_preferential
 * method post
 */
export interface RemovePreferentialUsingPOSTResponse {
    /** 响应数据 */
    data?: boolean
    /** 响应消息 */
    message?: string
...
/**
 * requestUrl /order/backend/stat/order_paid_sale_payment_collection_stat
 * method post
 */
...
/**
 * requestUrl /order/backend/stat/order_predict_stat
 * method post
 */
...
/**
 * requestUrl /order/front/detail_goods_order_buyer
 * method get
 */
export interface DetailGoodsOrderBuyerUsingGETResponse {
    /** 响应数据 */
    data?: 买家商品订单
    /** 响应消息 */
    message?: string
