...
import { getCompanyBackUrl, getParamsHistory, getPathParams, getSourceType } from '@/utils/urlUtils'
...
export default new (class loginHooks {
    ...
    getLoginData() {
        ...
        if (!token) getParamsHistory.replace(`/seller/login`)
    }
