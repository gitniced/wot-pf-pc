...
// import defaultLess from '@/styles/color.less'

// const lessTxt = require('@/styles/color.txt')
const lessTxt = require('@/styles/color.txt')

// import lessTxt from '@/styles/color.less'
...
const getLessData = async (themeObj: ThemeObj) => {
    ...
    // if (!lessData) {
    //     let tempLessData: any = await fetch(`${PUBLIC_PATH}color.less`)
    //     // console.log(defaultLess)
    //     lessData = await tempLessData.text()
    // }
    // const customLessData = lessData.replace(
