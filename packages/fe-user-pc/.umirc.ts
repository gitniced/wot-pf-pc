...
switch (process.env.BUILD_ENV) {
    case 'local':
        publicPath = `http://localhost:${process.env.PORT}/` //本地
        break
    case 'dev':
        publicPath = `https://static.zpimg.cn/dev/user-pc/` //开发
        break
    case 'test':
        publicPath = `https://static.zpimg.cn/test/user-pc/` //测试
        break
    case 'pre':
        publicPath = `https://static.zpimg.cn/pre/user-pc/` //预发
        break
    case 'pro':
        publicPath = `https://static.zpimg.cn/pro/user-pc/` //正式
        break
    default:
        //开发
...
const htmlConfig = {
    headScripts: [
        ...
        {
            src: `https://static.zpimg.cn/public/fe_user_pc/iconfont.js?randomKey=${randomKey}`,
        },
        {
...
export default defineConfig({
    ...
    dynamicImport: {
        //自定义loading组件
        loading: '@/components/Global/PageLoading/index',
    },
    antd: false,
    autoprefixer: {
        remove: false,
    ...
    define: {
        ...
        SPECIAL_USER: process.env.SPECIAL_USER,
