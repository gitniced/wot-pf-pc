...
const Word = () => {
    ...
    useSaasTitle(`${preview ? '预览' : code ? '编辑' : '新建'}在线文档`)
    ...
    const crumbData = useMemo(
        () => [
            ...
            {
                name: title,
                link: `/office/word${code ? `/${code}` : ''}${preview ? '?preview=true' : ''}${
        ...
        try {
            ...
            if (result) {
                ...
                if (history.length > 1) {
                    ...
                    if (!code) {
                        let url =
                            `/office/word/${result}` + `${fromType ? `?fromType=${fromType}` : ''}`
                        loading()
                        history.replace(url)
    ...
    return (
        <div className={styles.word}>
            ...
            <div className={styles.word_content}>
                <div className={styles.word_content_header}>
                    <div className={styles.word_content_header_title}>
                        {!preview && canEditName ? (
                            isEditingName ? (
                                <>
                                    <Input
                    ...
                    {preview || !canEditName ? null : (
                        <div className={styles.word_content_header_control}>
                ...
                <div
                    className={styles.word_content_body}
