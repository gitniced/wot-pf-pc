 ...
 * 简答题
 */
const EssayQuestion = ({ value, onChange, formNamespace }: QuestionComponentProps<IQuestion>) => {
    const { value: formValue, onChange: handleChange } = useComponentValue<IQuestion>({
        value,
        onChange,
        defaultValue: getQuestionDefaultValue(map => map.essay),
    })
...
export default React.memo(EssayQuestion)
