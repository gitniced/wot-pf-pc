 ...
 *  工具栏属性
 */
type IWpsCommandBarObjectAttr = Record<string, any>
...
interface IWpsCompatible {
    tabs?: {
        getTabs: () => Promise<{ tabKey: number; text: string }[]>
        switchTab: (tabKey: number) => Promise<any>
    }
    setCommandBars?: (args: IWpsCommandBars[]) => Promise<void>
    save?: () => Promise<any>
    ApiEvent?: {
...
// 声明全局 WebOfficeSDK
declare const WebOfficeSDK: IWebOfficeSDK
