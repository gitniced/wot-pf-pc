...
export const config: ComponentMapType = {
    [ModalType.ADD_REQUESTION]: {
        ...
        component: import(
            '@/pages/paper-library/[type]/examine/editTmp/components/ModalComponents/AddQuestionModal'
        ),
        width: 1000,
        centered: true,
    ...
    [ModalType.REMOVE_REQUESTION]: {
        ...
        component: import(
            '@/pages/paper-library/[type]/examine/editTmp/components/ModalComponents/RemoveQuestionModal'
        ),
        width: 1000,
        centered: true,
    ...
    [ModalType.NOTE]: {
        ...
        component: import(
            '@/pages/paper-library/[type]/examine/editTmp/components/ModalComponents/NoteModal'
        ),
        centered: true,
    ...
    [ModalType.QUESTION_REQUIRE]: {
        ...
        component: import(
            '@/pages/paper-library/[type]/examine/editTmp/components/ModalComponents/QuestionRequireModal'
        ),
        width: 695,
        centered: true,
        okText: ModalFooterText.CONFIRM,
    ...
    [ModalType.SCORE_DETAIL]: {
        ...
        component: import(
            '@/pages/paper-library/[type]/examine/editTmp/components/ModalComponents/ScoreDetailModal'
        ),
        width: 695,
        centered: true,
        okText: ModalFooterText.CONFIRM,
    ...
    [ModalType.BATCH_SET_SCORE]: {
        ...
        component: import(
            '@/pages/paper-library/[type]/examine/editTmp/components/ModalComponents/BatchSetScoreModal'
        ),
        width: 694,
        centered: true,
        okText: ModalFooterText.CONFIRM,
