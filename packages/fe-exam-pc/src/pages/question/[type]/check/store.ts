...
import type { CommonJobParams, CustomContent, KnowledgeOption, KnowledgeParams } from '../interface'
import { generateCommonJobList, generateKnowledgeList } from '../utils'
import type { RepeatedResultParams, RepeatTaskParams } from './interface'
